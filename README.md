# genpark-headless-commerce-cdp-cohort-ltv-analyzer-skill
...
> **GenPark AI Agent Skill** -- Headless commerce CDP and real-time cohort LTV predictive modeling (Chord Commerce style)
